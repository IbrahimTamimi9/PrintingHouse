//
//  OrdersDetailContainerView.swift
//  Avalon-Print
//
...
class OrdersDetailContainerView: UIView {
  ...
  let moreButton: UIButton = {
    ...
    moreButton.addTarget(self, action: #selector(OrdersDetailViewController.moreButtonTapped(_:)), for: .touchUpInside)
